...
#include "../../../../NeoCom/PhoneCompanyManager/PhoneManagerGUI/includes/loginpage.h"
...
template <> constexpr inline auto LoginPage::qt_create_metaobjectdata<qt_meta_tag_ZN9LoginPageE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "login_succsess",
        "",
        "on_registration_btn_clicked",
        "on_pass_rec_btn_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'login_succsess'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'on_registration_btn_clicked'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'on_pass_rec_btn_clicked'
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->login_succsess(); break;
        case 1: _t->on_registration_btn_clicked(); break;
        case 2: _t->on_pass_rec_btn_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)()>(_a, &LoginPage::login_succsess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)()>(_a, &LoginPage::on_registration_btn_clicked, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)()>(_a, &LoginPage::on_pass_rec_btn_clicked, 2))
            return;
    }
}
...
// SIGNAL 0
void LoginPage::login_succsess()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void LoginPage::on_registration_btn_clicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void LoginPage::on_pass_rec_btn_clicked()
{
