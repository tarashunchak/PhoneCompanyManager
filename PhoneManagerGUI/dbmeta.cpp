...
QMap<QString, QStringList> DatabaseManager::Columns::all_columns = {
    {"customers", {"id", "first_name", "last_name", "phone", "email", "date_of_B"
                   , "date", "tariff_id", "employee_id", "is_active", "comment_id", "balance"}}
    ,{"employees", {"id", "first_name", "last_name", "phone", "email", "date_of_B", "hire_date"
                    , "department_id", "position_id", "salary", "photo", "is_active", "comment_id"}}
    ,{"tariffs", {"id", "tariff_name", "monthly_price", "daily_price", "call_minutes", "internet_gb", "is_active"}}
